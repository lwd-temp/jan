  ...
  return toast.custom(
    (t) => {
      return (
        <div
          className={twMerge(
            'unset-drag dark:bg-zinc-white bg-foreground dark:border-border relative flex animate-enter items-center gap-x-4 rounded-lg px-4 py-2 text-white dark:border',
  ...
  return toast.custom(
    (t) => {
      return (
        <div
          className={twMerge(
            'unset-drag dark:bg-zinc-white bg-foreground dark:border-border relative bottom-2 flex animate-enter items-center gap-x-4 rounded-lg px-4 py-2 text-white dark:border',
            t.visible ? 'animate-enter' : 'animate-leave'
          )}
        >
          <div className="flex items-start gap-x-3 dark:text-black">
